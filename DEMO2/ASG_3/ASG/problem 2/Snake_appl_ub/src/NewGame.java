...
public class NewGame extends JDialog {
	...
	public NewGame() {
		...
		contentPanel.setLayout(null);
		{
			...
			separator.setBounds(10, 181, 560, 2);
			contentPanel.add(separator);
		}
		{
			JLabel lblSelectSize = new JLabel("Select Size :");
			lblSelectSize.setBounds(10, 190, 79, 14);
		...
		scrollPane.setBounds(254, 388, 316, 108);
		...
		playercount.setBounds(197, 11, 52, 22);
		...
		scrollPane_1.setBounds(10, 302, 560, 69);
		...
		resetall.setBounds(481, 507, 89, 23);
		contentPanel.add(resetall);
		
		create = new JButton("Create Board");
		create.setEnabled(false);
		create.setBounds(316, 224, 117, 49);
		contentPanel.add(create);
		
		reset = new JButton("Reset");
		reset.setEnabled(false);
		reset.setBounds(443, 224, 117, 49);
